...
int main(int argc, char* argv[])
{
    ...
    parser.add_options()("s,seed", "Seed for the random generator",
                         cxxopts::value<int>())(
        "i,initial", "Number of initial objects",
        cxxopts::value<unsigned>()->default_value("20000"))(
        "l,loops", "Number of loops to run",
        cxxopts::value<unsigned>()->default_value("2000"))(
        "o,ops", "Number of operations per iteration",
        cxxopts::value<unsigned>()->default_value("250"))("h,help",
                                                          "Print the help");
